...
# Content Table
#
# Extracts all the HTML tables from a page and strips out all layout information.
#
#
import os
...
class ContentTable():
    ...
    contains both a simplifed HTML table (new_element) and a list for rows (rows).
